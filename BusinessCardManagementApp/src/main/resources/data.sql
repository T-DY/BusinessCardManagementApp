...
INSERT INTO businesscard_list(id, user_email, company, business_name, card_image, bookmark) VALUES (1, 'admin@example.com', '株式会社タロウ', '山田 太郎', 'tarou.jpg', '1');
INSERT INTO businesscard_list(id, user_email, company, business_name, card_image, bookmark) VALUES (2, 'general@example.com', 'ジロウ株式会社', '五十嵐 二郎', 'jirou.jpg', '0');